...
namespace SemanticLogging.Contrib.Tests
{
    public enum MyColor { Red, Yellow, Blue }

    [EventSource(Name = "MyCompanyContrib")]
    public sealed class MyCompanyContribEventSource : EventSource
    {
        ...
        public static readonly MyCompanyContribEventSource Log = new MyCompanyContribEventSource();
    }
}
